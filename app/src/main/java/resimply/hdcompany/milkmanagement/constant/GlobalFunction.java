package resimply.hdcompany.milkmanagement.constant;
...
import resimply.hdcompany.milkmanagement.activity.MilkDetailActivity;
import resimply.hdcompany.milkmanagement.listener.IGetDateListener;
...
public class GlobalFunction {
    ...
    public static void goToMilkDetailActivity(Context context, Milk Milk) {
        Bundle bundle = new Bundle();
        bundle.putSerializable(Constants.KEY_INTENT_MILK_OBJECT, Milk);
        startActivity(context, MilkDetailActivity.class, bundle);
    }
