...
public class MilkOutOfStockActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_milk_out_of_stock);
    ...
    private void initToolbar() {
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle(getString(R.string.feature_milk_out_of_stock));
        ...
        edtSearchName.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (strKey.equals("") || strKey.length() == 0) {
                    mKeySearch = "";
                    getListMilk();
                    GlobalFunction.hideSoftKeyboard(MilkOutOfStockActivity.this);
                }
            }
        });
