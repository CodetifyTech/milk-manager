package resimply.hdcompany.milkmanagement.fragments;
...
public class MilkDetailAddedFragment extends Fragment {
    ...
    public MilkDetailAddedFragment(Milk Milk) {
        this.mMilk = Milk;
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mView = inflater.inflate(R.layout.fragment_milk_detail_added, container, false);
        initUi();
        return mView;
    }
    ...
    private void getListHistoryAdded() {
        ...
        MilkApplication.get(getActivity()).getHistoryDatabaseReference()
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                            ...
                            if (history != null) {
                                if (mMilk.getId() == history.getMilkId() && history.isAdd()) {
    ...
    private void displayLayoutBottomInfor() {
        // Calculator quantity
        String strTotalQuantity = getTotalQuantity() + " " + mMilk.getUnitName();
    ...
    private void onClickAddOrEditHistory(History history) {
        ...
        dialog.setContentView(R.layout.layout_dialog_detail_milk_edit);
        ...
        final TextView tvMilkName = dialog.findViewById(R.id.tv_milk_name);
        ...
        if (history == null) {
            ...
            tvMilkName.setText(mMilk.getName());
            tvUnitName.setText(mMilk.getUnitName());
        } else {
            tvTitleDialog.setText(getString(R.string.edit_history_add));
            tvMilkName.setText(history.getMilkName());
        ...
        tvDialogAdd.setOnClickListener(new IOnSingleClickListener() {
            ...
            public void onSingleClick(View v) {
                ...
                if (history == null) {
                    ...
                    history.setMilkId(mMilk.getId());
                    history.setMilkName(mMilk.getName());
                    history.setUnitId(mMilk.getUnitId());
                    history.setUnitName(mMilk.getUnitName());
                    ...
                    if (getActivity() != null) {
                        MilkApplication.get(getActivity()).getHistoryDatabaseReference()
                                ...
                                .setValue(history, (error, ref) -> {
                                    GlobalFunction.showToast(getActivity(), getString(R.string.msg_add_milk_success));
                                    changeQuantity(history.getMilkId(), history.getQuantity(), true);
                    ...
                    if (getActivity() != null) {
                        MilkApplication.get(getActivity()).getHistoryDatabaseReference()
                                ...
                                .updateChildren(map, (error, ref) -> {
                                    ...
                                    changeQuantity(history.getMilkId(), Integer.parseInt(strQuantity) - history.getQuantity(), true);
    ...
    private void changeQuantity(long MilkId, int quantity, boolean isAdd) {
        ...
        MilkApplication.get(getActivity()).getQuantityDatabaseReference(MilkId)
                .addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if (currentQuantity != null) {
                            ...
                            if (getActivity() != null) {
                                MilkApplication.get(getActivity()).getQuantityDatabaseReference(MilkId).removeEventListener(this);
                                MilkApplication.get(getActivity()).getQuantityDatabaseReference(MilkId).setValue(totalQuantity);
                            }
                        }
                    }
        ...
        new AlertDialog.Builder(getActivity())
                ...
                .setPositiveButton(getString(R.string.action_delete), (dialogInterface, i)
                        ...
                        .removeValue((error, ref) -> {
                            ...
                            changeQuantity(history.getMilkId(), history.getQuantity(), false);
                            GlobalFunction.hideSoftKeyboard(getActivity());
                        }))
