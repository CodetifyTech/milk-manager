...
public class MilkDetailUsedFragment extends Fragment {
    ...
    public MilkDetailUsedFragment(Milk Milk) {
        this.mMilk = Milk;
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mView = inflater.inflate(R.layout.fragment_milk_detail_used, container, false);
        initUi();
        return mView;
    }
                    ...
                    if (getActivity() != null) {
                        MilkApplication.get(getActivity()).getHistoryDatabaseReference()
                                ...
                                .setValue(history, (error, ref) -> {
                                    GlobalFunction.showToast(getActivity(), getString(R.string.msg_used_milk_success));
                    ...
                    if (getActivity() != null) {
                        MilkApplication.get(getActivity()).getHistoryDatabaseReference()
                                ...
                                .updateChildren(map, (error, ref) -> {
                                    ...
                                    changeQuantity(history.getMilkId(), Integer.parseInt(strQuantity) - history.getQuantity(), false);
